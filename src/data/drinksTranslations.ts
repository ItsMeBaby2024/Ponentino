...
export const drinksTranslations: Record<string, DrinkTranslation> = {
  ENFP: {
    ...
    pairingZh: ['義式佛卡夏', '布拉塔起司', '海鮮餐點', '沙拉', '義式奶凍'],
    menuDescriptionZh: "一款活力四射、氣泡雀躍的氣泡特調，結合了義大利自製檸檬利口酒 (Limoncello)、高檔橙皮甜酒 (Triple Sec) 和新鮮檸檬汁，最後優雅地注入清脆的普羅塞克氣泡酒 (Prosecco)。",
  ...
  ESTJ: {
    ...
    pairingZh: ['義式冷肉拼盤', '橄欖', '陳年起司', '牛排', '番茄義麵'],
    menuDescriptionZh: "最具代表性的義大利經典。乾琴酒的凌冽、金巴利 (Campari) 的甘苦，與芳香紅香艾酒 (Sweet Vermouth) 融匯成這杯濃烈深沉的完美諧奏。",
  ...
  ISTJ: {
    ...
    introZh: "循規蹈矩、典雅經典且完全值得信賴。歷史悠久的米蘭都靈代表了義式餐前酒 (Aperitivo) 文化的堅實基石，與你務實、嚴謹且忠誠的 ISTJ 檢查員性格高度契合。",
  ...
  ESTP: {
    ...
    introZh: "大膽、充滿活力，讓人瞬間沉醉。這款鮮豔的經典義式特調完美捕捉了 ESTP 實踐者腳踏實地、隨和有趣、熱愛享樂的精神。你永遠生活在最高清的畫面中。",
    pairingZh: ['佛卡夏', '海鮮餐點', '烤大蝦', '披薩'],
    menuDescriptionZh: "以義大利建國英雄命名的經典飲品。採用甘苦的金巴利，與新鮮打發至蓬鬆、富有空氣感的新鮮橙汁調和，呈現出精美的泡沫頂層。",
  ...
  ENTP: {
    ...
    pairingZh: ['海鮮餐點', '生蠔', '烤魚', '檸檬雞肉', '義式奶凍'],
    menuDescriptionZh: "對經典檸檬糖馬天尼的義式活力重塑。凜冽優質伏特加與阿瑪菲自製檸檬利口酒、橙皮甜酒以及酸爽檸檬汁搖勻，冰鎮呈杯。",
    ingredientsZh: ['伏特加 40毫升', '檸檬利口酒 30毫升', '橙皮甜酒 10毫升', '檸檬汁 20毫升']
  },
  ISTP: {
    nameZh: "義式瑪格麗特 (Italian Margarita)",
    tasteProfileZh: "酸爽柑橘、杏仁甘甜、大膽平衡",
    introZh: "乾淨利落、崇尚實用且技術流般讓人舒適。這杯比例精準、令人稱道的義式酸酒，將濃烈的龍舌蘭與甜美的杏仁利口酒完美結合，深得 ISTP 手藝人低調實幹、遊刃有餘的歡心。",
    pairingZh: ['披薩', '義式普切塔', '炸海鮮', '義式冷盤'],
    menuDescriptionZh: "對經典瑪格麗特的手工義式詮釋。以醇厚龍舌蘭和甜美杏仁酒 (Amaretto) 為基底，佐以新鮮壓榨的檸檬汁與橙汁，帶來清脆、柔滑的收尾。",
    ingredientsZh: ['龍舌蘭 45毫升', '橙皮甜酒 20毫升', '杏仁利口酒 10毫升', '檸檬汁 25毫升', '橙汁 20毫升']
  },
  ENTJ: {
    nameZh: "義式杏仁酸 (Amaretto Sour Italiano)",
    tasteProfileZh: "濃郁杏仁、酸甜柑橘、絲滑如絨",
    introZh: "精緻、果斷且令人過目難忘。這款帶有絲滑杏仁餘韻的濃烈酸酒，與你組織清晰、權威幹練且雄心勃勃的 ENTJ 指揮官個性相得益彰。",
    pairingZh: ['提拉米蘇', '義式脆餅', '巧克力甜點', '義式奶凍'],
    menuDescriptionZh: "一款優雅的義式經典。醇香甘美的杏仁利口酒與現榨檸檬汁、橙汁完美平衡，展現出結構嚴謹、如天鵝絨般絲滑的酸甜風味。",
  ...
  ESFP: {
    ...
    pairingZh: ['披薩', '義式普切塔', '海鮮餐點', '布拉塔起司', '義式冷肉'],
  ...
  ESFJ: {
    ...
    pairingZh: ['布拉塔起司', '帕爾馬火腿', '海鮮餐點', '佛卡夏', '清爽義麵'],
  ...
  INFJ: {
    ...
    introZh: "富有層次、深思熟慮且靜謐表達。這款將白蘭姆酒、橙皮甜酒和鳳梨汁交融的熱帶果香特調，與你溫和、深邃且充滿理想主義的 INFJ 倡導者靈魂完美契合。",
    pairingZh: ['海鮮餐點', '沙拉', '布拉塔起司', '義式奶凍'],
  ...
  INFP: {
    ...
    menuDescriptionZh: "一款絢麗而氣泡豐富的義式蘇打，混合了酸甜蔓越莓汁和新鮮橙汁，並優雅注入清脆起泡蘇打水。",
