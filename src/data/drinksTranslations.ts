...
export const drinksTranslations: Record<string, DrinkTranslation> = {
  ...
  ESTJ: {
    ...
    pairingZh: ['意式冷肉拼盤', '橄欖', '陳年起司', '牛排', '番茄義麵'],
  ...
  ESFP: {
    ...
    ingredientsZh: ['阿佩罗 45毫升', '橙汁 25毫升', '檸檬汁 10毫升', '薑汁啤酒 90毫升']
  },
  ESFJ: {
  ...
  INFJ: {
    ...
    introZh: "富有層次、深思熟慮且靜謐表達。這款將白蘭姆酒、橙皮甜酒和鳳梨汁交融的热帶果香特調，與你溫和、深邃且充滿理想主義的 INFJ 倡導者靈魂完美契合。",
    pairingZh: ['海鮮餐點', '沙拉', '布拉塔起司', '意式奶凍'],
    menuDescriptionZh: "一次優雅的热帶避世之旅。白蘭姆酒和優質橙皮甜酒，在新鮮檸檬汁和濃郁香甜的鳳梨汁注入下，達到無與倫比的果香平衡。",
  ...
  ISFP: {
    ...
    introZh: "溫柔、富有藝術氣息且感官細膩。這款口感順滑、色澤如玫瑰般絢麗的热帶無酒精調飲，極其契合你溫和、敏銳且充滿感官美學的 ISFP 藝術家作曲家靈魂。",
    pairingZh: ['帕爾馬火腿', '布拉塔起司', '海鮮沙拉', '雞肉', '水果甜點'],
    menuDescriptionZh: "一款優雅而絲滑的热帶無酒精飲品，將酸甜的蔓越莓汁與香甜濃郁的鳳梨汁完美融匯，帶來悠長綿密的果香愜意。",
    ingredientsZh: ['蔓越莓汁 60毫升', '鳳梨汁 90毫升']
  },
  ISFJ: {
    nameZh: "鳳梨鮮橙酷乐無醇版 (Pineapple Orange Cooler 0.0)",
    tasteProfileZh: "香甜橙汁、微酸檸檬、熱帶鳳梨",
    introZh: "溫暖、體貼且沁人心脾。這款讓人安心、比例絕佳的热帶柑橘無酒精特調，完美契合了你可靠、體貼入微且注重細節的 ISFJ 守護者天性。",
    pairingZh: ['海鮮餐點', '沙拉', '烤魚', '雞肉餐點', '素食義麵'],
    menuDescriptionZh: "一款令人舒心、充滿陽光氣息的热帶無酒精酷樂，融會了甜美的新鮮橙汁、清爽的檸檬汁與香甜濃郁的鳳梨汁。",
